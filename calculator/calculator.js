...
var configures = document.getElementById('configures');
...
function handler() {
  ...
  configures.innerHTML = JSON.stringify(
      determineBestStrategy(inputs.energy.value,
      inputs.artillery_level.value,
      inputs.barrage_level.value), null, 2);
}
